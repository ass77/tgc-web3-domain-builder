...
const tld = '.rexxie';
const CONTRACT_ADDRESS = '0x79A8690F116161E80c657Ce95126aE7542e3A997';
		...
		try {
			...
			if (ethereum) {
				...
				if (receipt.status === 1) {
					...
					alert(`Domain minted! View your freshly minted rexxie domain NFT at https://testnets.opensea.io/assets/mumbai/${CONTRACT_ADDRESS}/${tx.hash}`);
